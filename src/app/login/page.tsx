            ...
            {showAdminCode ? (
              <div className="space-y-2 pt-2 animate-in fade-in slide-in-from-top-2 duration-300">
                <label className="text-sm font-medium text-yellow-500/80 flex items-center gap-1.5 ml-1">
                  <Crown className="h-3.5 w-3.5" /> Access Code
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-5 w-5 text-yellow-500/40" />
                  <input
                    type="text"
                    placeholder="Enter owner or gift code"
                    value={adminCode}
              ...
              <button 
                ...
                className="text-xs text-slate-500 hover:text-brand-400 transition-colors ml-1"
              >
                Have an access code?
              </button>
            )}
