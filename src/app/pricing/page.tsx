...
const tiers = [
  {
    ...
    period: "/month",
    tasks: "50 tasks/mo",
    description: "Basic research & email automation for getting started.",
    features: [
  ...
  },
  {
    ...
    period: "/month",
    tasks: "200 tasks/mo",
    description: "Full web research + email outreach. Built for active operators.",
    features: [
      "200 AI tasks per month",
      "Full deep web research",
  ...
  },
  {
    ...
    description: "No caps. Priority everything. For founders who need an AI employee.",
    features: [
      "Unlimited AI tasks",
      "All Pro features",
