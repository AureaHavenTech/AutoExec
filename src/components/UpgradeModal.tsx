...
import { X, Sparkles, Lock, Zap, ArrowRight } from "lucide-react";
      ...
      <div className="relative w-full max-w-md animate-in zoom-in-95 duration-300">
        <Card className="p-0 overflow-hidden bg-slate-900 border border-slate-800 shadow-2xl shadow-brand-500/10">
          ...
          <div className="p-6 space-y-4">
            ...
            {/* CTA */}
            <Button className="w-full py-6 text-sm font-bold bg-brand-500 hover:bg-brand-600 text-slate-950 rounded-xl shadow-lg shadow-brand-500/20 transition-all">
